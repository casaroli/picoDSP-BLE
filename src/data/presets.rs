...
pub fn get_default_presets() -> [Preset; 128] {
    ...
    [
        ...
        p("Moog Bass",
          ...
          0.0, 0.0, filt(80.0, 0.286, 3000.0, 0.001, 0.25, 0.0, 0.1), env(0.001, 0.2, 0.8, 0.1),
        ...
        p("Deep Sub",
          ...
          0.0, 0.0, filt(800.0, 0.062, 0.0, 0.001, 0.1, 1.0, 0.1), env(0.002, 0.15, 0.9, 0.12),
          false, no_lfo, delay_set(0.25, 0.3, 0.3, false), reverb_set(0.5, 0.5, 0.1, false)),
        p("Reese Bass",
          osc(Saw, 1.0, -2.0, 1.5, false), osc(Saw, 1.0, -2.0, -1.5, false), osc(Saw, 0.6, -1.0, 0.4, false),
          0.0, 0.0, filt(400.0, 0.5, 1500.0, 0.005, 0.4, 0.7, 0.2), env(0.005, 0.3, 0.9, 0.2),
        ...
        p("Acid Bass",
          ...
          0.0, 0.55, filt(120.0, 0.8, 4500.0, 0.003, 0.2, 0.1, 0.1), env(0.003, 0.2, 0.9, 0.1),
        ...
        p("Rubber Bass",
          ...
          0.0, 0.0, filt(180.0, 0.667, 2500.0, 0.002, 0.18, 0.2, 0.12), env(0.002, 0.2, 0.7, 0.1),
        ...
        p("Wobble Bass",
          ...
          0.0, 0.0, filt(300.0, 0.727, 1000.0, 0.005, 0.3, 0.7, 0.2), env(0.005, 0.2, 0.9, 0.2),
        ...
        p("Square Sub",
          ...
          0.0, 0.0, filt(500.0, 0.25, 800.0, 0.002, 0.2, 0.8, 0.1), env(0.003, 0.15, 0.85, 0.1),
        ...
        p("Growl Bass",
          ...
          0.1, 0.0, filt(160.0, 0.769, 3000.0, 0.004, 0.3, 0.4, 0.15), env(0.004, 0.25, 0.8, 0.15),
        ...
        p("Pluck Bass",
          ...
          0.0, 0.0, filt(250.0, 0.7, 5000.0, 0.001, 0.15, 0.0, 0.1), env(0.001, 0.2, 0.0, 0.12),
        ...
        p("FM Bass",
          ...
          0.0, 0.0, filt(600.0, 0.571, 1200.0, 0.001, 0.2, 0.5, 0.12), env(0.001, 0.18, 0.7, 0.1),
        ...
        p("Detuned Bass",
          ...
          0.0, 0.0, filt(350.0, 0.571, 1500.0, 0.004, 0.25, 0.6, 0.15), env(0.004, 0.2, 0.85, 0.15),
        ...
        p("808 Boom",
          ...
          0.0, 0.5, filt(1200.0, 0.167, 0.0, 0.001, 0.05, 1.0, 0.1), env(0.001, 1.2, 0.0, 0.6),
        ...
        p("Hoover Bass",
          ...
          0.0, 0.3, filt(450.0, 0.667, 2000.0, 0.005, 0.3, 0.6, 0.2), env(0.005, 0.25, 0.85, 0.2),
        ...
        p("Dub Bass",
          ...
          0.0, 0.2, filt(220.0, 0.5, 600.0, 0.01, 0.3, 0.6, 0.2), env(0.01, 0.25, 0.7, 0.25),
        ...
        p("Talking Bass",
          ...
          0.0, 0.0, filt(300.0, 0.769, 2500.0, 0.005, 0.25, 0.5, 0.15), env(0.005, 0.2, 0.8, 0.15),
        ...
        p("Synth Bass 1",
          ...
          0.0, 0.0, filt(280.0, 0.625, 2200.0, 0.002, 0.22, 0.4, 0.12), env(0.002, 0.2, 0.75, 0.12),
        ...
        p("Saw Bass",
          ...
          0.0, 0.0, filt(220.0, 0.571, 1800.0, 0.002, 0.2, 0.5, 0.12), env(0.002, 0.18, 0.8, 0.12),
        ...
        p("Mini Bass",
          ...
          0.0, 0.0, filt(260.0, 0.667, 2600.0, 0.001, 0.2, 0.3, 0.1), env(0.001, 0.2, 0.7, 0.1),
        ...
        p("Lucky Man",
          ...
          0.0, 0.92, filt(200.0, 0.211, 3000.0, 0.1, 1.5, 0.4, 0.5), env(0.05, 0.2, 1.0, 0.5),
        ...
        p("Tom Sawyer",
          ...
          0.0, 0.0, filt(80.0, 0.231, 5000.0, 0.03, 2.0, 0.1, 0.1), env(0.01, 0.1, 1.0, 0.2),
        ...
        p("Moog Scream",
          ...
          0.15, 0.85, filt(100.0, 0.824, 6000.0, 0.005, 0.3, 0.2, 0.2), env(0.005, 0.2, 1.0, 0.2),
        ...
        p("Octavarium Lead",
          ...
          0.0, 0.94, filt(500.0, 0.286, 4000.0, 0.01, 0.5, 0.6, 0.2), env(0.005, 0.1, 1.0, 0.2),
        ...
        p("Super Saw Lead",
          ...
          0.0, 0.0, filt(3000.0, 0.167, 3000.0, 0.01, 0.5, 0.7, 0.3), env(0.01, 0.2, 1.0, 0.3),
        ...
        p("Square Lead",
          ...
          0.0, 0.0, filt(2500.0, 0.25, 2000.0, 0.005, 0.3, 0.8, 0.2), env(0.005, 0.15, 1.0, 0.2),
        ...
        p("Mini Lead",
          ...
          0.0, 0.4, filt(1800.0, 0.571, 2500.0, 0.005, 0.4, 0.7, 0.2), env(0.005, 0.2, 1.0, 0.2),
        ...
        p("Sync Lead",
          ...
          0.0, 0.0, filt(1200.0, 0.727, 4000.0, 0.005, 0.5, 0.6, 0.2), env(0.005, 0.2, 1.0, 0.2),
        ...
        p("Whistle Lead",
          ...
          0.0, 0.3, filt(4000.0, 0.4, 1000.0, 0.02, 0.3, 0.9, 0.2), env(0.02, 0.2, 1.0, 0.25),
        ...
        p("Portamento Lead",
          ...
          0.0, 0.95, filt(900.0, 0.667, 3500.0, 0.01, 0.5, 0.7, 0.25), env(0.01, 0.2, 1.0, 0.3),
        ...
        p("Bright Saw Lead",
          ...
          0.0, 0.0, filt(5000.0, 0.4, 2000.0, 0.005, 0.3, 0.8, 0.2), env(0.005, 0.15, 1.0, 0.2),
        ...
        p("Soft Lead",
          ...
          0.0, 0.2, filt(2500.0, 0.25, 1500.0, 0.03, 0.4, 0.9, 0.3), env(0.03, 0.2, 1.0, 0.35),
        ...
        p("Fifth Lead",
          ...
          0.0, 0.0, filt(2200.0, 0.5, 2500.0, 0.008, 0.4, 0.7, 0.2), env(0.008, 0.2, 1.0, 0.25),
        ...
        p("Trance Lead",
          ...
          0.0, 0.0, filt(2800.0, 0.571, 3500.0, 0.005, 0.4, 0.8, 0.25), env(0.005, 0.2, 1.0, 0.3),
        ...
        p("Screaming Lead",
          ...
          0.05, 0.5, filt(700.0, 0.842, 6000.0, 0.004, 0.4, 0.5, 0.2), env(0.004, 0.2, 1.0, 0.25),
        ...
        p("Pulse Lead",
          ...
          0.0, 0.0, filt(2000.0, 0.5, 2500.0, 0.006, 0.35, 0.8, 0.2), env(0.006, 0.18, 1.0, 0.22),
        ...
        p("Vintage Lead",
          ...
          0.0, 0.6, filt(1500.0, 0.625, 3000.0, 0.01, 0.5, 0.6, 0.25), env(0.01, 0.2, 1.0, 0.3),
        ...
        p("Octave Lead",
          ...
          0.0, 0.0, filt(2600.0, 0.4, 2500.0, 0.006, 0.35, 0.8, 0.2), env(0.006, 0.18, 1.0, 0.22),
        ...
        p("Glass Pad",
          ...
          0.0, 0.0, filt(1200.0, 0.118, 1500.0, 0.8, 1.0, 0.8, 1.5), env(0.9, 0.5, 1.0, 1.8),
        ...
        p("Warm Pad",
          ...
          0.0, 0.0, filt(900.0, 0.4, 1200.0, 1.0, 1.2, 0.85, 1.8), env(1.0, 0.6, 1.0, 2.0),
        ...
        p("String Pad",
          ...
          0.0, 0.0, filt(1600.0, 0.25, 1500.0, 0.6, 1.0, 0.85, 1.2), env(0.7, 0.5, 1.0, 1.4),
        ...
        p("Choir Pad",
          ...
          0.05, 0.0, filt(2000.0, 0.5, 1000.0, 0.9, 1.0, 0.9, 1.6), env(0.9, 0.6, 1.0, 1.8),
        ...
        p("Sweep Pad",
          ...
          0.0, 0.0, filt(400.0, 0.667, 4000.0, 2.0, 2.0, 0.8, 2.0), env(0.8, 1.0, 1.0, 2.0),
        ...
        p("Dark Pad",
          ...
          0.0, 0.0, filt(500.0, 0.5, 800.0, 1.2, 1.5, 0.7, 2.0), env(1.2, 0.8, 1.0, 2.5),
        ...
        p("Shimmer Pad",
          ...
          0.0, 0.0, filt(3000.0, 0.25, 1500.0, 0.7, 1.0, 0.85, 1.6), env(0.8, 0.6, 1.0, 2.0),
        ...
        p("Analog Pad",
          ...
          0.0, 0.0, filt(1100.0, 0.444, 1500.0, 0.7, 1.0, 0.8, 1.4), env(0.7, 0.6, 1.0, 1.6),
        ...
        p("Soft Pad",
          ...
          0.0, 0.0, filt(1500.0, 0.167, 800.0, 1.0, 1.0, 0.9, 1.8), env(1.0, 0.6, 1.0, 2.0),
        ...
        p("Evolving Pad",
          ...
          0.0, 0.0, filt(700.0, 0.571, 3000.0, 1.5, 2.0, 0.75, 2.2), env(1.0, 1.0, 1.0, 2.5),
        ...
        p("Octave Pad",
          ...
          0.0, 0.0, filt(1400.0, 0.318, 1500.0, 0.8, 1.0, 0.85, 1.5), env(0.8, 0.6, 1.0, 1.7),
        ...
        p("Detuned Pad",
          ...
          0.0, 0.0, filt(1000.0, 0.4, 1500.0, 0.9, 1.0, 0.85, 1.6), env(0.9, 0.6, 1.0, 1.8),
        ...
        p("Ambient Pad",
          ...
          0.0, 0.0, filt(2200.0, 0.25, 1200.0, 1.5, 1.5, 0.85, 2.5), env(1.5, 1.0, 1.0, 3.0),
        ...
        p("Voltage Pad",
          ...
          0.0, 0.0, filt(800.0, 0.625, 2500.0, 1.0, 1.5, 0.8, 2.0), env(0.9, 0.8, 1.0, 2.2),
        ...
        p("Halo Pad",
          ...
          0.0, 0.0, filt(3500.0, 0.211, 1000.0, 1.0, 1.2, 0.85, 2.0), env(1.0, 0.8, 1.0, 2.5),
        ...
        p("Wide Pad",
          ...
          0.0, 0.0, filt(1300.0, 0.348, 1500.0, 0.8, 1.0, 0.85, 1.6), env(0.9, 0.6, 1.0, 1.8),
        ...
        p("Aurora Pad",
          ...
          0.0, 0.0, filt(1800.0, 0.5, 2500.0, 1.3, 1.5, 0.8, 2.2), env(1.3, 0.9, 1.0, 2.5),
        ...
        p("Mystic Pad",
          ...
          0.0, 0.0, filt(1600.0, 0.4, 2000.0, 1.2, 1.4, 0.8, 2.0), env(1.2, 0.8, 1.0, 2.4),
        ...
        p("Rock Organ",
          ...
          0.0, 0.0, filt(6000.0, 0.4, 0.0, 0.005, 0.0, 1.0, 0.05), env(0.005, 0.0, 1.0, 0.06),
        ...
        p("Electric Piano",
          ...
          0.0, 0.0, filt(4000.0, 0.167, 1500.0, 0.001, 0.6, 0.3, 0.4), env(0.001, 0.8, 0.3, 0.4),
        ...
        p("Soft Clav",
          ...
          0.0, 0.0, filt(1200.0, 0.625, 3000.0, 0.001, 0.25, 0.1, 0.15), env(0.001, 0.3, 0.2, 0.15),
        ...
        p("Jazz Organ",
          ...
          0.0, 0.0, filt(7500.0, 0.25, 0.0, 0.004, 0.0, 1.0, 0.05), env(0.004, 0.0, 1.0, 0.06),
        ...
        p("Percussive Organ",
          ...
          0.0, 0.0, filt(8000.0, 0.25, 2000.0, 0.001, 0.15, 1.0, 0.05), env(0.001, 0.2, 0.8, 0.06),
        ...
        p("Combo Organ",
          ...
          0.0, 0.0, filt(5000.0, 0.25, 0.0, 0.005, 0.0, 1.0, 0.05), env(0.005, 0.0, 1.0, 0.06),
        ...
        p("Reed Organ",
          ...
          0.0, 0.0, filt(4500.0, 0.25, 500.0, 0.04, 0.0, 1.0, 0.12), env(0.04, 0.0, 1.0, 0.15),
        ...
        p("Bell Piano",
          ...
          0.0, 0.0, filt(5000.0, 0.118, 1000.0, 0.001, 1.0, 0.2, 0.6), env(0.001, 1.0, 0.2, 0.8),
        ...
        p("Synth Clav",
          ...
          0.0, 0.0, filt(1500.0, 0.667, 4000.0, 0.001, 0.2, 0.0, 0.12), env(0.001, 0.25, 0.0, 0.12),
        ...
        p("Snappy Pluck",
          ...
          0.0, 0.0, filt(300.0, 0.667, 5000.0, 0.001, 0.18, 0.0, 0.15), env(0.001, 0.25, 0.0, 0.2),
        ...
        p("Nylon Pluck",
          ...
          0.0, 0.0, filt(2500.0, 0.25, 2000.0, 0.001, 0.4, 0.0, 0.3), env(0.001, 0.5, 0.0, 0.3),
        ...
        p("Synth Pluck",
          ...
          0.0, 0.0, filt(800.0, 0.571, 4000.0, 0.001, 0.25, 0.0, 0.2), env(0.001, 0.3, 0.0, 0.25),
        ...
        p("Glass Pluck",
          ...
          0.0, 0.0, filt(5000.0, 0.25, 2000.0, 0.001, 0.3, 0.0, 0.3), env(0.001, 0.4, 0.0, 0.4),
          false, no_lfo, delay_set(0.3, 0.35, 0.3, true), reverb_set(0.65, 0.4, 0.25, true)),
        p("Square Pluck",
          osc(Square, 1.0, 0.0, 0.0, false), osc(Square, 0.4, 1.0, 0.2, false), no_osc,
          0.0, 0.0, filt(1000.0, 0.5, 3500.0, 0.001, 0.2, 0.0, 0.18), env(0.001, 0.25, 0.0, 0.2),
        ...
        p("Koto Pluck",
          ...
          0.0, 0.0, filt(3000.0, 0.4, 3000.0, 0.001, 0.3, 0.0, 0.25), env(0.001, 0.4, 0.0, 0.3),
        ...
        p("Harp Pluck",
          ...
          0.0, 0.0, filt(4000.0, 0.167, 2000.0, 0.001, 0.6, 0.0, 0.5), env(0.001, 0.7, 0.0, 0.6),
        ...
        p("Muted Pluck",
          ...
          0.0, 0.0, filt(900.0, 0.5, 1500.0, 0.001, 0.12, 0.0, 0.1), env(0.001, 0.15, 0.0, 0.12),
        ...
        p("Bright Pluck",
          ...
          0.0, 0.0, filt(6000.0, 0.4, 3000.0, 0.001, 0.2, 0.0, 0.2), env(0.001, 0.25, 0.0, 0.22),
        ...
        p("Bass Pluck",
          ...
          0.0, 0.0, filt(500.0, 0.625, 4000.0, 0.001, 0.2, 0.0, 0.15), env(0.001, 0.25, 0.0, 0.18),
        ...
        p("Fat Brass",
          ...
          0.0, 0.0, filt(400.0, 0.167, 4000.0, 0.08, 0.4, 0.6, 0.3), env(0.03, 0.2, 1.0, 0.3),
        ...
        p("PWM Strings",
          ...
          0.0, 0.0, filt(2000.0, 0.118, 1200.0, 0.4, 0.8, 0.8, 0.8), env(0.5, 0.5, 1.0, 0.9),
        ...
        p("Synth Brass",
          ...
          0.0, 0.0, filt(600.0, 0.5, 4500.0, 0.05, 0.3, 0.7, 0.25), env(0.04, 0.2, 1.0, 0.25),
        ...
        p("Brass Section",
          ...
          0.0, 0.0, filt(700.0, 0.4, 4000.0, 0.07, 0.4, 0.7, 0.3), env(0.06, 0.25, 1.0, 0.3),
        ...
        p("Soft Strings",
          ...
          0.0, 0.0, filt(1800.0, 0.25, 1200.0, 0.5, 0.8, 0.85, 1.0), env(0.6, 0.5, 1.0, 1.2),
        ...
        p("Saw Strings",
          ...
          0.0, 0.0, filt(2200.0, 0.318, 1500.0, 0.4, 0.7, 0.85, 0.9), env(0.5, 0.5, 1.0, 1.0),
        ...
        p("Octave Brass",
          ...
          0.0, 0.0, filt(650.0, 0.444, 4000.0, 0.06, 0.35, 0.7, 0.3), env(0.05, 0.25, 1.0, 0.3),
        ...
        p("Trumpet Lead",
          ...
          0.0, 0.3, filt(800.0, 0.571, 4500.0, 0.04, 0.3, 0.6, 0.2), env(0.03, 0.2, 1.0, 0.2),
        ...
        p("Horn Section",
          ...
          0.0, 0.0, filt(550.0, 0.348, 3500.0, 0.1, 0.5, 0.7, 0.35), env(0.08, 0.3, 1.0, 0.35),
        ...
        p("String Ensemble",
          ...
          0.0, 0.0, filt(2000.0, 0.211, 1500.0, 0.6, 1.0, 0.85, 1.2), env(0.7, 0.6, 1.0, 1.4),
        ...
        p("Cinematic Strings",
          ...
          0.0, 0.0, filt(1500.0, 0.286, 2500.0, 1.2, 1.2, 0.85, 2.0), env(1.0, 0.8, 1.0, 2.2),
        ...
        p("Brass Stab",
          ...
          0.0, 0.0, filt(900.0, 0.5, 4000.0, 0.005, 0.2, 0.0, 0.15), env(0.005, 0.25, 0.0, 0.18),
        ...
        p("Crystal Bell",
          ...
          0.0, 0.0, filt(6000.0, 0.062, 0.0, 0.001, 1.5, 0.0, 1.5), env(0.001, 1.5, 0.0, 1.8),
        ...
        p("Glass Bell",
          ...
          0.0, 0.0, filt(7000.0, 0.118, 0.0, 0.001, 1.2, 0.0, 1.2), env(0.001, 1.2, 0.0, 1.5),
        ...
        p("Tubular Bell",
          ...
          0.0, 0.0, filt(5500.0, 0.062, 0.0, 0.001, 2.5, 0.1, 2.5), env(0.001, 2.5, 0.1, 3.0),
        ...
        p("Music Box",
          ...
          0.0, 0.0, filt(8000.0, 0.118, 0.0, 0.001, 0.8, 0.0, 0.8), env(0.001, 0.8, 0.0, 1.0),
        ...
        p("Marimba",
          ...
          0.0, 0.0, filt(4000.0, 0.167, 1000.0, 0.001, 0.4, 0.0, 0.3), env(0.001, 0.45, 0.0, 0.35),
          false, no_lfo, delay_set(0.25, 0.25, 0.15, true), reverb_set(0.5, 0.45, 0.18, true)),
        p("Vibraphone",
          osc(Sine, 1.0, 0.0, 0.0, true), osc(Sine, 0.4, 2.0, 0.0, true), osc(Triangle, 0.2, 1.0, 0.0, false),
          0.0, 0.0, filt(5000.0, 0.118, 500.0, 0.001, 1.2, 0.3, 1.0), env(0.001, 1.2, 0.3, 1.2),
        ...
        p("Kalimba",
          ...
          0.0, 0.0, filt(3500.0, 0.25, 1500.0, 0.001, 0.5, 0.0, 0.4), env(0.001, 0.5, 0.0, 0.45),
        ...
        p("Glockenspiel",
          ...
          0.0, 0.0, filt(9000.0, 0.062, 0.0, 0.001, 0.7, 0.0, 0.6), env(0.001, 0.7, 0.0, 0.7),
        ...
        p("Temple Bell",
          ...
          0.0, 0.0, filt(4500.0, 0.118, 0.0, 0.001, 3.0, 0.0, 3.0), env(0.001, 3.0, 0.0, 3.5),
        ...
        p("Celesta",
          ...
          0.0, 0.0, filt(7500.0, 0.118, 0.0, 0.001, 1.0, 0.0, 0.9), env(0.001, 1.0, 0.0, 1.0),
        ...
        p("Acid Line",
          ...
          0.0, 0.6, filt(120.0, 0.8, 4000.0, 0.005, 0.25, 0.2, 0.1), env(0.005, 0.2, 1.0, 0.1),
        ...
        p("Sequence Saw",
          ...
          0.0, 0.0, filt(700.0, 0.667, 4000.0, 0.001, 0.18, 0.0, 0.12), env(0.001, 0.2, 0.0, 0.12),
        ...
        p("Pluck Arp",
          ...
          0.0, 0.0, filt(900.0, 0.571, 4500.0, 0.001, 0.15, 0.0, 0.1), env(0.001, 0.18, 0.0, 0.12),
          false, no_lfo, delay_set(0.1875, 0.45, 0.35, true), reverb_set(0.45, 0.5, 0.15, true)),
        p("Square Arp",
          osc(Square, 1.0, 0.0, 0.0, false), osc(Square, 0.4, 1.0, 0.2, false), no_osc,
          0.0, 0.0, filt(1200.0, 0.5, 3500.0, 0.001, 0.12, 0.0, 0.1), env(0.001, 0.15, 0.0, 0.1),
        ...
        p("Octave Arp",
          ...
          0.0, 0.0, filt(1000.0, 0.571, 4000.0, 0.001, 0.15, 0.0, 0.1), env(0.001, 0.18, 0.0, 0.12),
          false, no_lfo, delay_set(0.1875, 0.45, 0.35, true), reverb_set(0.45, 0.5, 0.15, true)),
        p("Digital Arp",
          osc(Square, 1.0, 0.0, 0.0, false), osc(Saw, 0.3, 2.0, 0.0, false), osc(Sine, 0.3, 1.0, 0.0, false),
          0.0, 0.0, filt(2500.0, 0.4, 3000.0, 0.001, 0.1, 0.0, 0.08), env(0.001, 0.12, 0.0, 0.1),
          false, no_lfo, delay_set(0.125, 0.5, 0.4, true), reverb_set(0.5, 0.45, 0.18, true)),
        p("Soft Arp",
          osc(Triangle, 1.0, 0.0, 0.0, false), osc(Sine, 0.5, 1.0, 0.0, false), no_osc,
          0.0, 0.0, filt(1500.0, 0.25, 2000.0, 0.001, 0.25, 0.0, 0.2), env(0.001, 0.3, 0.0, 0.2),
        ...
        p("Chase Sequence",
          ...
          0.0, 0.0, filt(800.0, 0.727, 4000.0, 0.001, 0.12, 0.0, 0.1), env(0.001, 0.15, 0.0, 0.1),
        ...
        p("Sci-Fi Drone",
          ...
          0.0, 0.0, filt(600.0, 0.211, 2000.0, 2.5, 2.0, 0.7, 2.5), env(2.0, 1.0, 1.0, 3.0),
        ...
        p("Deep Drone",
          ...
          0.0, 0.0, filt(400.0, 0.4, 1000.0, 3.0, 2.0, 0.8, 3.0), env(2.5, 1.5, 1.0, 3.5),
        ...
        p("Ocean Drone",
          ...
          0.3, 0.0, filt(800.0, 0.5, 1500.0, 3.0, 2.5, 0.7, 3.5), env(3.0, 2.0, 1.0, 4.0),
        ...
        p("Metallic Drone",
          ...
          0.0, 0.0, filt(1200.0, 0.667, 2000.0, 2.0, 2.0, 0.8, 3.0), env(1.5, 1.0, 1.0, 3.0),
        ...
        p("Dark Atmosphere",
          ...
          0.1, 0.0, filt(350.0, 0.571, 1500.0, 3.0, 2.5, 0.6, 4.0), env(2.5, 2.0, 1.0, 4.0),
          true, lfo(0.04, LTri, 0.0, 700.0), delay_set(0.3, 0.55, 0.35, true), reverb_set(0.98, 0.25, 0.45, true)),
        p("Space Wind",
          no_osc, no_osc, no_osc,
          0.8, 0.0, filt(600.0, 0.727, 3000.0, 2.5, 2.5, 0.7, 3.0), env(2.5, 1.5, 1.0, 3.5),
        ...
        p("Tension Drone",
          ...
          0.0, 0.0, filt(700.0, 0.667, 2500.0, 2.0, 2.0, 0.75, 3.0), env(1.8, 1.2, 1.0, 3.0),
        ...
        p("Underwater",
          ...
          0.1, 0.0, filt(500.0, 0.571, 1000.0, 2.0, 2.0, 0.7, 3.0), env(2.0, 1.5, 1.0, 3.0),
        ...
        p("Cosmic Wash",
          ...
          0.0, 0.0, filt(2500.0, 0.25, 2000.0, 2.5, 2.0, 0.8, 3.5), env(2.5, 1.5, 1.0, 4.0),
        ...
        p("Cinematic Pad",
          ...
          0.0, 0.0, filt(1000.0, 0.4, 3000.0, 2.0, 2.0, 0.8, 3.0), env(1.8, 1.2, 1.0, 3.5),
        ...
        p("Riser FX",
          ...
          0.5, 0.0, filt(200.0, 0.727, 6000.0, 2.0, 2.0, 1.0, 1.0), env(1.5, 0.5, 1.0, 0.5),
        ...
        p("Down Sweep",
          ...
          0.2, 0.95, filt(8000.0, 0.667, -6000.0, 0.001, 2.0, 0.0, 1.0), env(0.001, 2.0, 0.0, 1.0),
        ...
        p("Laser Zap",
          ...
          0.0, 0.9, filt(6000.0, 0.769, -4000.0, 0.001, 0.3, 0.0, 0.2), env(0.001, 0.35, 0.0, 0.2),
        ...
        p("Alarm",
          ...
          0.0, 0.0, filt(4000.0, 0.571, 0.0, 0.005, 0.0, 1.0, 0.05), env(0.005, 0.0, 1.0, 0.05),
          true, lfo(4.0, LSqr, 0.0, 3000.0), delay_set(0.25, 0.3, 0.2, true), reverb_set(0.5, 0.5, 0.15, true)),
        p("Wind Noise",
          no_osc, no_osc, no_osc,
          1.0, 0.0, filt(800.0, 0.769, 4000.0, 1.0, 1.0, 0.8, 1.5), env(1.0, 0.5, 1.0, 1.5),
        ...
        p("UFO",
          ...
          0.0, 0.0, filt(3000.0, 0.727, 2000.0, 0.01, 0.5, 1.0, 0.5), env(0.05, 0.3, 1.0, 0.5),
        ...
        p("Synth Kick",
          osc(Sine, 1.0, -2.0, 0.0, false), osc(Sine, 0.3, -1.0, 0.0, false), no_osc,
          0.0, 0.0, filt(2000.0, 0.4, 4000.0, 0.001, 0.08, 0.0, 0.08), env(0.001, 0.18, 0.0, 0.12),
        ...
        p("Synth Tom",
          ...
          0.1, 0.0, filt(1500.0, 0.5, 3000.0, 0.001, 0.2, 0.0, 0.15), env(0.001, 0.25, 0.0, 0.18),
          false, no_lfo, delay_set(0.25, 0.3, 0.1, false), reverb_set(0.4, 0.5, 0.1, true)),
        p("Zap Snare",
          osc(Triangle, 0.7, 0.0, 0.0, false), no_osc, no_osc,
          0.8, 0.0, filt(2500.0, 0.571, 3000.0, 0.001, 0.15, 0.0, 0.12), env(0.001, 0.2, 0.0, 0.15),
          false, no_lfo, delay_set(0.2, 0.3, 0.15, true), reverb_set(0.5, 0.5, 0.12, true)),
        p("Noise Hat",
          no_osc, no_osc, no_osc,
          1.0, 0.0, filt(9000.0, 0.667, 0.0, 0.001, 0.05, 0.0, 0.04), env(0.001, 0.06, 0.0, 0.05),
